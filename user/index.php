...
<body>
    <div class="header">
        <span></span>
        <span>Listify</span>
        <img class="countryFlag" src="../images/brazil.png" alt="">
    </div>
    ...
    <div class="pageContent">
        ...
        <div class="centerContent">
            ...
            if (isset($topTracks)) {
                ...
                $trackUri = $topTracks->items[0]->uri;
            ?>
            <div class="listenedSong">
                <div class="songImageContainer">
                    <img class="songImage" src="<?php echo ($trackImage) ?>" alt="Most Listened Song"
                        onclick="changeTrack('<?php echo ($trackUri); ?>', '<?php echo ($accessToken); ?>')">
                    <i class="fa fa-play songImageIcon" aria-hidden="true"
                        onclick="changeTrack('<?php echo ($trackUri); ?>', '<?php echo ($accessToken); ?>')"></i>
                </div>
