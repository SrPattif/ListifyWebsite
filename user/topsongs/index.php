    ...
    ?>
        <div class="listeningNotification">
            <div class="top">
                ...
                <div class="text">
                    <span class="songName"><?php echo ($songName) ?></span><br><span class="songAuthor"><?php echo ($songAuthorName) ?></span>
                </div>
            </div>
            <div class="bottom">
                <i class="fa fa-desktop" aria-hidden="true"></i> Em <span class="deviceName"><?php echo ($deviceName) ?></span><br>
            </div>
        </div>
                ...
                <div class="imageContainer" id="imgContainer">
                    <div class="imgContent" id="imgContent">
                        ...
                        ?>
                            ...
                            <img class="mostListenedImage" src="<?php echo ($songImage); ?>" alt="<?php echo ($songName); ?>" crossorigin="anonymous">

                            <br>
                            <h2 class="artistName"><?php echo ($songName); ?></h2>
                            <span class="artistDescription">é a música mais ouvida de <span class="userName" id="usernameSpan"><?php echo ($userName); ?></span><?php
                                                                                                                                                                if ($timeType == "long_term") {
                                                                                                                                                                ?>!
                            <?php
                                                                                                                                                                } else if ($timeType == "medium_term") {
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <img src="<?php echo ($songImage); ?>" alt="<?php echo ($songName); ?>" crossorigin="anonymous">
